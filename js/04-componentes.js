...
//    "mi ubicación actual" porque ya no se está ahí physicalmente).
...
function MapaUbicacion({
  ...
  React.useEffect(() => {
    ...
    // Sin ubicación previa: arranca centrado en San Miguel de Tucumán (zona
    // de trabajo) — con ubicación previa, centrado ahí con el pin puesto.
  ...
  // Si lat/lng cambian desde afuera (ej: botón "Usar mi ubicación actual"),
  // mover/crear el pin y recentrar sin reinicializar todo el mapa.
  React.useEffect(() => {
