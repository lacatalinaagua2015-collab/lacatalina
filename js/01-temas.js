...
const TEMAS_LC = {
  ...
  "claro-azul":     { nombre:"Gris Claro",      modo:"claro",  emoji:"🌫️", vars:{"--color-background-primary":"#f2f2f3","--color-background-secondary":"#ffffff","--color-background-tertiary":"#e6e6e8","--color-background-info":"#e8e9eb","--color-background-success":"#d1fae5","--color-background-warning":"#fef3c7","--color-background-danger":"#fee2e2","--color-text-primary":"#242527","--color-text-secondary":"#54575c","--color-text-tertiary":"#6b6f75","--color-text-info":"#4b4f56","--color-text-success":"#065f46","--color-text-warning":"#92400e","--color-text-danger":"#991b1b","--color-border-tertiary":"rgba(0,0,0,0.07)","--color-border-secondary":"rgba(0,0,0,0.13)","--color-border-primary":"rgba(0,0,0,0.22)","--color-accent":"#6b7280","body-bg":"#e2e2e4"} },
