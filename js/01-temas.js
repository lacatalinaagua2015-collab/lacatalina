...
const TEMAS_LC = {
  ...
  "oscuro-rojo":    { nombre:"Grafito",         modo:"oscuro", emoji:"🪨", vars:{"--color-background-primary":"#18191b","--color-background-secondary":"#232428","--color-background-tertiary":"#2e3035","--color-background-info":"#2b2d31","--color-background-success":"#0a2e1f","--color-background-warning":"#2e1f06","--color-background-danger":"#2e0a0a","--color-text-primary":"#e8e9eb","--color-text-secondary":"#a7abb3","--color-text-tertiary":"#888d96","--color-text-info":"#b0b5bd","--color-text-success":"#4dd9a0","--color-text-warning":"#f5b942","--color-text-danger":"#f07070","--color-border-tertiary":"rgba(255,255,255,0.07)","--color-border-secondary":"rgba(255,255,255,0.13)","--color-border-primary":"rgba(255,255,255,0.22)","--color-accent":"#6b7280","body-bg":"#0d0e10"} },
  "claro-azul":     { nombre:"Gris Claro",      modo:"claro",  emoji:"🌫️", vars:{"--color-background-primary":"#e2e2e4","--color-background-secondary":"#ffffff","--color-background-tertiary":"#d3d3d6","--color-background-info":"#d8d9dc","--color-background-success":"#d1fae5","--color-background-warning":"#fef3c7","--color-background-danger":"#fee2e2","--color-text-primary":"#242527","--color-text-secondary":"#54575c","--color-text-tertiary":"#6b6f75","--color-text-info":"#4b4f56","--color-text-success":"#065f46","--color-text-warning":"#92400e","--color-text-danger":"#991b1b","--color-border-tertiary":"rgba(0,0,0,0.09)","--color-border-secondary":"rgba(0,0,0,0.16)","--color-border-primary":"rgba(0,0,0,0.25)","--color-accent":"#6b7280","body-bg":"#c9c9cc"} },
...
function aplicarTemaLC(temaId) {
  ...
  // --color-accent-solid: copia SIEMPRE lisa del acento, sin importar el
  // estilo. En Metálico, --color-accent se pisa más abajo con un
  // linear-gradient (sirve para "background"), pero varios lugares lo usan
  // en "border"/"boxShadow" — ahí un gradient es un valor inválido y el
  // navegador lo ignora entero, así que ese borde/resalte queda sin pintar.
  // Esta variable paralela siempre tiene el color plano para esos casos.
  root.style.setProperty("--color-accent-solid", tema.vars["--color-accent"]);
