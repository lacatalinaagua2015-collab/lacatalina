...
function GestionClientes({
  ...
  // Paginación de render (cargar de a tandas para no dibujar cientos de filas de una)
  ...
  const moverCliente = (idOrigen, idDestino) => {
    ...
    if (origen.dia !== destino.dia) {
      lcAlert("Solo podés reordenar dentro del mismo día.");
      return;
    }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => {
      ...
      window.lcConfirm("¿Reordenar todos los clientes eliminando los huecos en la numeración?").then(function (ok) {
        if (ok) onReordenarTodo(compactados);
      });
    }
  ...
  })), (clienteMoviendo ? filtrados : filtrados.slice(0, limite)).map(c => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    style: {
      ...s.card,
  ...
  }, "✓ Registrar cambio")))))), !clienteMoviendo && filtrados.length > limite && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Cargar más (", filtrados.length - limite, " restantes)")), filtrados.length === 0 && !modoNuevo && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "40px 20px",
