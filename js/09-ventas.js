...
function NuevaVenta({
  ...
  // embebido (compacto=true, sin envoltorio) como dentro de la pantalla
  // completa de abajo (con header, info del cliente y botones No está/No
  // quiere/Saltar alrededor). Antes la pantalla completa tenía su propio
  // JSX distinto acá abajo; ahora comparten exactamente el mismo cuerpo.
